...
public class TileManager {
    ...
    public TileManager(GamePanel gp) {
        ...
        tile = new Tile[10]; // assuming we have 10 different tiles
        getTileImage();
        loadMap();
    ...
    public void getTileImage() {
        ...
        try {
            System.out.println("Tile path test: " + getClass().getResource("/res/tiles/grass.png"));
    ...
    try {
        ...
        while (row < gp.maxScreenRow) {
            ...
            if (line == null) break; // safety check
